...
function linkHover(num) {
    ...
    nums.splice(num-1, 1)
    document.getElementById(`link-nav-${num}`).style.cssText += 'width: 1000px;height: 350px;transform: rotate(0deg);box-shadow: 10px 10px 10px 10px rgba(1, 34, 31, 0.212);'
...
function linkHover2(num) {
    ...
    nums.splice(num-1, 1)
    document.getElementById(`link-nav2-${num}`).style.cssText += 'width: 1000px;height: 450px;transform: rotate(0deg);box-shadow: 10px 10px 10px 10px rgba(1, 34, 31, 0.212);'
...
var loadInterval = setInterval(() => {
    ...
    1100 - scroll2 < 600 ? document.getElementById('conteiner-preto').style.top = `${600}px` : document.getElementById('conteiner-preto').style.top = `${1100 - scroll2}px`
}, 100)

var _relevantes = 0
function relevantesE() {
    _relevantes+1 > 2 ? 0 : _relevantes++
    _relevantes >= 0 ? document.getElementById('relevantes-e').style.marginLeft = `${1700*_relevantes}px` : 0
    _relevantes <= 0 ? document.getElementById('relevantes-d').style.marginLeft = `${1700*(Math.abs(_relevantes))}px` : 0
}
